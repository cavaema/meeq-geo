#!/bin/bash
# Script per inizializzare Git sul Raspberry Pi
# Eseguire sul Raspberry Pi

set -e

echo "🔧 Inizializzazione Git - Meeq Local"
echo "====================================="
echo ""
...
echo ""
echo "📝 Prossimi passi:"
echo "   1. Crea repository su GitHub/GitLab: meeq-local"
echo "   2. Aggiungi remote:"
echo "      git remote add origin https://github.com/TUO-USERNAME/meeq-local.git"
